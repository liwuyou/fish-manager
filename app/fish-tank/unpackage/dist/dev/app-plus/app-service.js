...
__definePage('pages/bind/index', function () {
  return Vue.extend(__webpack_require__(/*! pages/bind/index.vue?mpType=page */ 34).default);
});
...
"use strict";
eval("/* WEBPACK VAR INJECTION */(function(__f__) {\n\nvar _interopRequireDefault = __webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ 1);\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.default = void 0;\nvar _regenerator = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/regenerator */ 12));\nvar _asyncToGenerator2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ 14));\nvar _storage = __webpack_require__(/*! @/utils/storage */ 15);\nvar _api = __webpack_require__(/*! @/utils/api */ 16);\nfunction _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== \"undefined\" && o[Symbol.iterator] || o[\"@@iterator\"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === \"number\") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError(\"Invalid attempt to iterate non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(o); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\nvar _default = {\n  data: function data() {\n    return {\n      devices: [],\n      searchKey: '',\n      lastUpdateTime: '',\n      timer: null,\n      phoneNumber: '',\n      editMode: false,\n      selectedDevices: [],\n      renameVisible: false,\n      renameValue: '',\n      renameDevice: null,\n      ws: null,\n      wsReconnectTimer: null\n    };\n  },\n  computed: {\n    filteredDevices: function filteredDevices() {\n      var _this = this;\n      if (!this.searchKey) return this.devices;\n      return this.devices.filter(function (d) {\n        var name = _this.getDeviceName(d);\n        return d.device_key.includes(_this.searchKey) || name.includes(_this.searchKey);\n      });\n    }\n  },\n  onLoad: function onLoad() {\n    var _this2 = this;\n    this.phoneNumber = (0, _storage.getPhoneNumber)() || '';\n    this.loadDevices();\n    this.timer = setInterval(function () {\n      _this2.loadDevices();\n    }, 30000); // 改为30秒轮询（WebSocket推送实时更新）\n\n    this.connectWS();\n  },\n  onUnload: function onUnload() {\n    if (this.timer) {\n      clearInterval(this.timer);\n    }\n    this.disconnectWS();\n  },\n  methods: {\n    getDeviceName: function getDeviceName(device) {\n      var key = 'device_name_' + device.device_key;\n      var name = uni.getStorageSync(key);\n      return name || device.device_key;\n    },\n    startRename: function startRename(device) {\n      this.renameDevice = device;\n      this.renameValue = this.getDeviceName(device) === device.device_key ? '' : this.getDeviceName(device);\n      this.renameVisible = true;\n    },\n    cancelRename: function cancelRename() {\n      this.renameVisible = false;\n      this.renameDevice = null;\n      this.renameValue = '';\n    },\n    confirmRename: function confirmRename() {\n      if (!this.renameDevice) return;\n      var key = 'device_name_' + this.renameDevice.device_key;\n      if (this.renameValue && this.renameValue.trim()) {\n        uni.setStorageSync(key, this.renameValue.trim());\n        uni.showToast({\n          title: '重命名成功',\n          icon: 'success'\n        });\n      } else {\n        uni.removeStorageSync(key);\n        uni.showToast({\n          title: '已恢复默认名称',\n          icon: 'none'\n        });\n      }\n      this.$forceUpdate();\n      this.cancelRename();\n    },\n    // ===== WebSocket 实时推送 =====\n    getWSBaseURL: function getWSBaseURL() {\n      try {\n        if (window && window.location) {\n          return \"ws://\".concat(window.location.host);\n        }\n      } catch (e) {}\n      return 'ws://192.168.2.11:7965';\n    },\n    connectWS: function connectWS() {\n      var _this3 = this;\n      if (this.ws) return;\n      var phone = (0, _storage.getPhoneNumber)();\n      if (!phone) return;\n      try {\n        var baseUrl = this.getWSBaseURL();\n        this.ws = uni.connectSocket({\n          url: \"\".concat(baseUrl, \"/ws/client\"),\n          success: function success() {}\n        });\n        this.ws.onOpen(function () {\n          uni.sendSocketMessage({\n            data: JSON.stringify({\n              type: 'auth',\n              phone: phone\n            })\n          });\n        });\n        this.ws.onMessage(function (res) {\n          try {\n            var msg = JSON.parse(res.data);\n            if (msg.type === 'device_status') {\n              // 设备状态变化，实时更新列表\n              var idx = _this3.devices.findIndex(function (d) {\n                return d.device_key === msg.device_key;\n              });\n              if (idx > -1) {\n                _this3.devices[idx].online = msg.online;\n                // 更新状态数据\n                if (msg.status) {\n                  _this3.devices[idx].status = msg.status;\n                }\n                _this3.lastUpdateTime = new Date().toLocaleTimeString();\n                _this3.$forceUpdate();\n              }\n            }\n          } catch (e) {}\n        });\n        this.ws.onClose(function () {\n          _this3.ws = null;\n          if (!_this3.wsReconnectTimer) {\n            _this3.wsReconnectTimer = setTimeout(function () {\n              _this3.wsReconnectTimer = null;\n              _this3.connectWS();\n            }, 5000);\n          }\n        });\n        this.ws.onError(function () {});\n      } catch (e) {\n        __f__(\"log\", 'WebSocket连接失败', e, \" at pages/devices/index.vue:227\");\n      }\n    },\n    disconnectWS: function disconnectWS() {\n      if (this.wsReconnectTimer) {\n        clearTimeout(this.wsReconnectTimer);\n        this.wsReconnectTimer = null;\n      }\n      if (this.ws) {\n        try {\n          this.ws.close();\n        } catch (e) {}\n        this.ws = null;\n      }\n    },\n    loadDevices: function loadDevices() {\n      var _this4 = this;\n      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {\n        var phone, res;\n        return _regenerator.default.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                phone = (0, _storage.getPhoneNumber)();\n                if (phone) {\n                  _context.next = 3;\n                  break;\n                }\n                return _context.abrupt(\"return\");\n              case 3:\n                _context.prev = 3;\n                _context.next = 6;\n                return (0, _api.getDevices)(phone);\n              case 6:\n                res = _context.sent;\n                if (res.success) {\n                  _this4.devices = res.devices || [];\n                  _this4.lastUpdateTime = new Date().toLocaleTimeString();\n                }\n                _context.next = 13;\n                break;\n              case 10:\n                _context.prev = 10;\n                _context.t0 = _context[\"catch\"](3);\n                __f__(\"error\", '加载设备失败', _context.t0, \" at pages/devices/index.vue:253\");\n              case 13:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee, null, [[3, 10]]);\n      }))();\n    },\n    refreshDevices: function refreshDevices() {\n      uni.showLoading({\n        title: '刷新中...'\n      });\n      this.loadDevices().then(function () {\n        uni.hideLoading();\n      });\n    },\n    handleLogout: function handleLogout() {\n      uni.showModal({\n        title: '确认退出',\n        content: '确定要退出登录吗？',\n        success: function success(res) {\n          if (res.confirm) {\n            (0, _storage.clearPhoneNumber)();\n            uni.redirectTo({\n              url: '/pages/login/index'\n            });\n          }\n        }\n      });\n    },\n    goToBind: function goToBind() {\n      uni.navigateTo({\n        url: '/pages/bind/index'\n      });\n    },\n    handleDeviceClick: function handleDeviceClick(device) {\n      if (this.editMode) {\n        var index = this.selectedDevices.indexOf(device.device_key);\n        if (index > -1) {\n          this.selectedDevices.splice(index, 1);\n        } else {\n          this.selectedDevices.push(device.device_key);\n        }\n      } else {\n        // 根据型号跳转不同控制页\n        var page = '/pages/control/index';\n        if (device.model === 'fish_one') {\n          page = '/pages/control/fish-one';\n        }\n        // fish_mini 有自己的独立 App，不在此跳转\n        uni.navigateTo({\n          url: \"\".concat(page, \"?device_key=\").concat(device.device_key)\n        });\n      }\n    },\n    enterEditMode: function enterEditMode() {\n      this.editMode = true;\n      this.selectedDevices = [];\n    },\n    exitEditMode: function exitEditMode() {\n      this.editMode = false;\n      this.selectedDevices = [];\n    },\n    batchDelete: function batchDelete() {\n      var _this5 = this;\n      return (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee3() {\n        return _regenerator.default.wrap(function _callee3$(_context3) {\n          while (1) {\n            switch (_context3.prev = _context3.next) {\n              case 0:\n                if (!(_this5.selectedDevices.length === 0)) {\n                  _context3.next = 2;\n                  break;\n                }\n                return _context3.abrupt(\"return\");\n              case 2:\n                uni.showModal({\n                  title: '确认删除',\n                  content: \"\\u786E\\u5B9A\\u8981\\u5220\\u9664\\u9009\\u4E2D\\u7684 \".concat(_this5.selectedDevices.length, \" \\u4E2A\\u8BBE\\u5907\\u5417\\uFF1F\"),\n                  success: function () {\n                    var _success = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(res) {\n                      var phone, successCount, _iterator, _step, key, result;\n                      return _regenerator.default.wrap(function _callee2$(_context2) {\n                        while (1) {\n                          switch (_context2.prev = _context2.next) {\n                            case 0:\n                              if (res.confirm) {\n                                _context2.next = 2;\n                                break;\n                              }\n                              return _context2.abrupt(\"return\");\n                            case 2:\n                              phone = (0, _storage.getPhoneNumber)();\n                              successCount = 0;\n                              _iterator = _createForOfIteratorHelper(_this5.selectedDevices);\n                              _context2.prev = 5;\n                              _iterator.s();\n                            case 7:\n                              if ((_step = _iterator.n()).done) {\n                                _context2.next = 21;\n                                break;\n                              }\n                              key = _step.value;\n                              _context2.prev = 9;\n                              _context2.next = 12;\n                              return (0, _api.unbindDevice)(phone, key);\n                            case 12:\n                              result = _context2.sent;\n                              if (result.success) successCount++;\n                              uni.removeStorageSync('device_name_' + key);\n                              _context2.next = 19;\n                              break;\n                            case 17:\n                              _context2.prev = 17;\n                              _context2.t0 = _context2[\"catch\"](9);\n                            case 19:\n                              _context2.next = 7;\n                              break;\n                            case 21:\n                              _context2.next = 26;\n                              break;\n                            case 23:\n                              _context2.prev = 23;\n                              _context2.t1 = _context2[\"catch\"](5);\n                              _iterator.e(_context2.t1);\n                            case 26:\n                              _context2.prev = 26;\n                              _iterator.f();\n                              return _context2.finish(26);\n                            case 29:\n                              uni.showToast({\n                                title: \"\\u5220\\u9664\\u6210\\u529F \".concat(successCount, \" \\u4E2A\"),\n                                icon: 'success'\n                              });\n                              _this5.exitEditMode();\n                              _this5.loadDevices();\n                            case 32:\n                            case \"end\":\n                              return _context2.stop();\n                          }\n                        }\n                      }, _callee2, null, [[5, 23, 26, 29], [9, 17]]);\n                    }));\n                    function success(_x) {\n                      return _success.apply(this, arguments);\n                    }\n                    return success;\n                  }()\n                });\n              case 3:\n              case \"end\":\n                return _context3.stop();\n            }\n          }\n        }, _callee3);\n      }))();\n    }\n  }\n};\nexports.default = _default;\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/vue-cli-plugin-uni/lib/format-log.js */ 23)[\"default\"]))//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///22\n");
...
var render = function () {
  ...
  return _c(
    ...
    [
          ...
          _c(
            ...
            [
              _c(
                "view",
                {
                  staticClass: _vm._$s(3, "sc", "status-indicator"),
                  attrs: { _i: 3 },
                },
                [
                  _c("view", {
                    staticClass: _vm._$s(4, "sc", "indicator-dot"),
                    attrs: { _i: 4 },
                  }),
                  _c("text", [
                    _vm._v(
              ...
              _c(
                "text",
                {
                  staticClass: _vm._$s(6, "sc", "device-key"),
                  attrs: { _i: 6 },
                },
                [_vm._v(_vm._$s(6, "t0-0", _vm._s(_vm.deviceKey)))]
              ),
            ]
          ),
        ]
      ...
      _c(
        "view",
        { staticClass: _vm._$s(7, "sc", "sensor-section"), attrs: { _i: 7 } },
        [
          _c(
            "view",
            {
              staticClass: _vm._$s(8, "sc", "sensor-grid two-col"),
              attrs: { _i: 8 },
            },
            [
              _c(
                "view",
                {
                  staticClass: _vm._$s(9, "sc", "sensor-item"),
                  attrs: { _i: 9 },
                },
                [
                  _c("text", {
                    staticClass: _vm._$s(10, "sc", "sensor-icon"),
                    attrs: { _i: 10 },
                  }),
                  _c("text", {
                    staticClass: _vm._$s(11, "sc", "sensor-label"),
                    attrs: { _i: 11 },
                  }),
                  _c(
                    "text",
                    {
                      staticClass: _vm._$s(12, "sc", "sensor-value"),
                      attrs: { _i: 12 },
                    },
                    [
                      _vm._v(
              ...
              _c(
                "view",
                {
                  staticClass: _vm._$s(13, "sc", "sensor-item"),
                  attrs: { _i: 13 },
                },
                [
                  _c("text", {
                    staticClass: _vm._$s(14, "sc", "sensor-icon"),
                    attrs: { _i: 14 },
                  }),
                  _c("text", {
                    staticClass: _vm._$s(15, "sc", "sensor-label"),
                    attrs: { _i: 15 },
                  }),
                  _c(
                    "text",
                    {
                      staticClass: _vm._$s(16, "sc", "sensor-value"),
                      attrs: { _i: 16 },
                    },
                    [
                      _vm._v(
                      ...
                      _c(
                        "text",
                        {
                          staticClass: _vm._$s(17, "sc", "wq-tag"),
                          class: _vm._$s(17, "c", _vm.waterQualityClass),
                          attrs: { _i: 17 },
                        },
                        [
                          _vm._v(
                            _vm._$s(17, "t0-0", _vm._s(_vm.waterQualityText))
                          ),
                        ]
                      ),
                    ]
      ...
      _c(
        "view",
        {
          staticClass: _vm._$s(18, "sc", "big-btn-section"),
          attrs: { _i: 18 },
        },
        [
          _c(
            "view",
            {
              staticClass: _vm._$s(19, "sc", "big-btn-row"),
              attrs: { _i: 19 },
            },
            [
              _c(
                "view",
                {
                  staticClass: _vm._$s(20, "sc", "big-btn-wrapper"),
                  attrs: { _i: 20 },
                },
                [
                  _c(
                    "view",
                    {
                      staticClass: _vm._$s(21, "sc", "big-btn"),
                      class: _vm._$s(
                        21,
                        "c",
                    ...
                    [
                      _c("text", {
                        staticClass: _vm._$s(22, "sc", "big-btn-icon"),
                        attrs: { _i: 22 },
                      }),
                      _c(
                        "text",
                        {
                          staticClass: _vm._$s(23, "sc", "big-btn-label"),
                          attrs: { _i: 23 },
                        },
                        [
                          _vm._v(
              ...
              _c(
                "view",
                {
                  staticClass: _vm._$s(24, "sc", "big-btn-wrapper"),
                  attrs: { _i: 24 },
                },
                [
                  _c(
                    "view",
                    {
                      staticClass: _vm._$s(25, "sc", "big-btn feed-btn"),
                      class: _vm._$s(25, "c", { busy: _vm.status.servoMoving }),
                      attrs: { _i: 25 },
                      on: { click: _vm.triggerServo },
                    },
                    [
                      _c("text", {
                        staticClass: _vm._$s(26, "sc", "big-btn-icon"),
                        attrs: { _i: 26 },
                      }),
                      _c(
                        "text",
                        {
                          staticClass: _vm._$s(27, "sc", "big-btn-label"),
                          attrs: { _i: 27 },
                        },
                        [
                          _vm._v(
      ...
      _c(
        ...
        [
          _c(
            "view",
            {
              staticClass: _vm._$s(29, "sc", "control-card"),
              attrs: { _i: 29 },
            },
            [
              _c(
                "view",
                {
                  staticClass: _vm._$s(30, "sc", "control-header"),
                  attrs: { _i: 30 },
                },
                [
                  _c(
                    "text",
                    {
                      staticClass: _vm._$s(31, "sc", "control-name"),
                      attrs: { _i: 31 },
                      on: {
                        click: function ($event) {
                          return _vm.startRename("pump1", "水泵1")
                  ...
                  _c(
                    "text",
                    {
                      staticClass: _vm._$s(32, "sc", "control-value"),
                      attrs: { _i: 32 },
                    },
                    [
                      _vm._v(
              ...
              _c(
                "view",
                {
                  staticClass: _vm._$s(33, "sc", "pump-controls"),
                  attrs: { _i: 33 },
                },
                _vm._l(
                  _vm._$s(34, "f", { forItems: _vm.pumpLevels }),
                  function (level, index, $20, $30) {
                    return _c(
                      "button",
                      {
                        key: _vm._$s(34, "f", { forIndex: $20, key: index }),
                        staticClass: _vm._$s("34-" + $30, "sc", "level-btn"),
                      ...
                      [_vm._v(_vm._$s("34-" + $30, "t0-0", _vm._s(level)))]
                    )
                  }
                ),
                0
          ...
          _c(
            ...
            [
              ...
              _c(
                "view",
                {
                  staticClass: _vm._$s(39, "sc", "pump-controls"),
                  attrs: { _i: 39 },
                },
                _vm._l(
                  _vm._$s(40, "f", { forItems: _vm.pumpLevels }),
                  function (level, index, $21, $31) {
                    return _c(
                      "button",
                      {
                        key: _vm._$s(40, "f", { forIndex: $21, key: index }),
                        staticClass: _vm._$s("40-" + $31, "sc", "level-btn"),
                      ...
                      [_vm._v(_vm._$s("40-" + $31, "t0-0", _vm._s(level)))]
                    )
                  }
                ),
                0
          ...
          _c(
            "view",
            {
              staticClass: _vm._$s(41, "sc", "control-card"),
              attrs: { _i: 41 },
            },
            [
              _c(
                "view",
                {
                  staticClass: _vm._$s(42, "sc", "control-header"),
                  attrs: { _i: 42 },
                },
                [
                  _c(
                    "text",
                    {
                      staticClass: _vm._$s(43, "sc", "control-name"),
                      attrs: { _i: 43 },
                      on: {
                        click: function ($event) {
                  ...
                  _c(
                    "text",
                    {
                      staticClass: _vm._$s(44, "sc", "control-value"),
                      attrs: { _i: 44 },
                    },
                    [
                      _vm._v(
              ...
              _c(
                "view",
                {
                  staticClass: _vm._$s(45, "sc", "pump-controls"),
                  attrs: { _i: 45 },
                },
                _vm._l(
                  _vm._$s(46, "f", { forItems: _vm.pumpLevels }),
                  function (level, index, $22, $32) {
                    return _c(
                      "button",
                      {
                        ...
                        staticClass: _vm._$s("46-" + $32, "sc", "level-btn"),
                        class: _vm._$s("46-" + $32, "c", {
                          active: (_vm.status.airPumpLevel || 0) === index,
                        }),
                        attrs: { _i: "46-" + $32 },
                        on: {
                      ...
                      [_vm._v(_vm._$s("46-" + $32, "t0-0", _vm._s(level)))]
                    )
                  }
                ),
                0
          ...
          _c(
            "view",
            {
              staticClass: _vm._$s(47, "sc", "control-card"),
              attrs: { _i: 47 },
            },
            [
              _c(
                "view",
                {
                  staticClass: _vm._$s(48, "sc", "control-header"),
                  attrs: { _i: 48 },
                },
                [
                  _c(
                    "text",
                    {
                      staticClass: _vm._$s(49, "sc", "control-name"),
                      attrs: { _i: 49 },
                      on: {
                        click: function ($event) {
                          return _vm.startRename("fan", "风扇")
                  ...
                  _c(
                    "text",
                    {
                      staticClass: _vm._$s(50, "sc", "control-value"),
                      attrs: { _i: 50 },
                    },
                    [
                      _vm._v(
              ...
              _c(
                "view",
                {
                  staticClass: _vm._$s(51, "sc", "pump-controls"),
                  attrs: { _i: 51 },
                },
                _vm._l(
                  _vm._$s(52, "f", { forItems: _vm.pumpLevels }),
                  function (level, index, $23, $33) {
                    return _c(
                      "button",
                      {
                        ...
                        staticClass: _vm._$s("52-" + $33, "sc", "level-btn"),
                      ...
                      [_vm._v(_vm._$s("52-" + $33, "t0-0", _vm._s(level)))]
                    )
                  }
                ),
                0
          ...
          _c(
            "view",
            {
              staticClass: _vm._$s(53, "sc", "control-card"),
              attrs: { _i: 53 },
            },
            [
              _c(
                "view",
                {
                  staticClass: _vm._$s(54, "sc", "control-header"),
                  attrs: { _i: 54 },
                },
                [
                  _c(
                    "text",
                    {
                      staticClass: _vm._$s(55, "sc", "control-name"),
                      attrs: { _i: 55 },
                      on: {
                        click: function ($event) {
                  ...
                  _c(
                    "text",
                    {
                      staticClass: _vm._$s(56, "sc", "control-value"),
                      attrs: { _i: 56 },
                    },
                    [
                      _vm._v(
              ...
              _c(
                "view",
                {
                  staticClass: _vm._$s(57, "sc", "pump-controls"),
                  attrs: { _i: 57 },
                },
                _vm._l(
                  _vm._$s(58, "f", { forItems: _vm.pumpLevels }),
                  function (level, index, $24, $34) {
                    return _c(
                      "button",
                      {
                        ...
                        staticClass: _vm._$s("58-" + $34, "sc", "level-btn"),
                        class: _vm._$s("58-" + $34, "c", {
                          active: _vm.status.pwm3Level === index,
                        }),
                        attrs: { _i: "58-" + $34 },
                        on: {
                      ...
                      [_vm._v(_vm._$s("58-" + $34, "t0-0", _vm._s(level)))]
                    )
                  }
                ),
                0
      ...
      _c(
        "view",
        {
          staticClass: _vm._$s(59, "sc", "control-section"),
          attrs: { _i: 59 },
        },
        [
          _c(
            "view",
            {
              staticClass: _vm._$s(60, "sc", "switch-card"),
              attrs: { _i: 60 },
            },
            [
              _c(
                "text",
                {
                  staticClass: _vm._$s(61, "sc", "switch-label"),
                  attrs: { _i: 61 },
                  on: {
                    click: function ($event) {
                      return _vm.startRename("uv", "UV灯")
                ...
                [
                  _vm._v(
                    _vm._$s(61, "t0-0", _vm._s(_vm.getCtrlName("uv", "UV灯")))
                  ),
                ]
              ),
              _c(
                "view",
                {
                  staticClass: _vm._$s(62, "sc", "custom-switch"),
                  class: _vm._$s(62, "c", _vm.status.uvLightOn ? "on" : "off"),
                  attrs: { _i: 62 },
                  on: {
                    click: function ($event) {
                      return _vm.setUV(!_vm.status.uvLightOn)
                ...
                [
                  _c("view", {
                    staticClass: _vm._$s(63, "sc", "custom-switch-knob"),
                    attrs: { _i: 63 },
                  }),
                ]
              ),
          ...
          _c(
            "view",
            {
              staticClass: _vm._$s(64, "sc", "switch-card"),
              attrs: { _i: 64 },
            },
            [
              _c(
                "text",
                {
                  staticClass: _vm._$s(65, "sc", "switch-label"),
                  attrs: { _i: 65 },
                  on: {
                    click: function ($event) {
              ...
              _c(
                "view",
                {
                  staticClass: _vm._$s(66, "sc", "custom-switch"),
                  class: _vm._$s(
                    66,
                    "c",
                    _vm.status.relay2State ? "on" : "off"
                ...
                [
                  _c("view", {
                    staticClass: _vm._$s(67, "sc", "custom-switch-knob"),
                    attrs: { _i: 67 },
                  }),
                ]
              ),
      ...
      _c(
        "view",
        {
          staticClass: _vm._$s(68, "sc", "control-section"),
          attrs: { _i: 68 },
        },
        [
          _c("view", {
            staticClass: _vm._$s(69, "sc", "section-title"),
            attrs: { _i: 69 },
          }),
          _vm._$s(70, "i", _vm.timers.length === 0)
            ? _c(
                "view",
                {
                  staticClass: _vm._$s(70, "sc", "empty-tip"),
                  attrs: { _i: 70 },
                },
                [_c("text")]
              )
            : _vm._e(),
          _vm._l(
            _vm._$s(72, "f", { forItems: _vm.timers }),
            function (timer, index, $25, $35) {
              return _c(
                "view",
                {
                  key: _vm._$s(72, "f", { forIndex: $25, key: timer.id }),
                  staticClass: _vm._$s("72-" + $35, "sc", "timer-card"),
                  attrs: { _i: "72-" + $35 },
                },
                [
                  _c(
                    ...
                    [
                      _c(
                        ...
                        [
                          _c(
                            ...
                            [
                              _vm._v(
                                _vm._$s("75-" + $35, "t0-0", _vm._s(timer.name))
                              ),
                            ]
                          ),
                          _c(
                      ...
                      _c(
                        "text",
                        {
                          staticClass: _vm._$s("77-" + $35, "sc", "timer-desc"),
                          attrs: { _i: "77-" + $35 },
                        },
                        [
                          _vm._v(
          ...
          _c("button", {
            staticClass: _vm._$s(84, "sc", "add-timer-btn"),
            attrs: { _i: 84 },
            on: {
              click: function ($event) {
                return _vm.openTimerDialog(null)
      ...
      _c(
        "view",
        { staticClass: _vm._$s(85, "sc", "bottom-bar"), attrs: { _i: 85 } },
        [
          _c(
            "text",
            {
              staticClass: _vm._$s(86, "sc", "refresh-time"),
              attrs: { _i: 86 },
            },
            [_vm._v(_vm._$s(86, "t0-0", _vm._s(_vm.lastUpdateTime)))]
          ),
          _c("button", {
            staticClass: _vm._$s(87, "sc", "refresh-btn"),
            attrs: { _i: 87 },
            on: { click: _vm.refreshStatus },
          }),
        ]
      ),
      _vm._$s(88, "i", _vm.timerDialogVisible)
        ? _c(
            "view",
            {
              staticClass: _vm._$s(88, "sc", "dialog-overlay"),
              attrs: { _i: 88 },
              on: { click: _vm.closeTimerDialog },
            },
            [
              _c(
                "view",
                {
                  staticClass: _vm._$s(89, "sc", "dialog-box timer-dialog"),
                  attrs: { _i: 89 },
                  on: {
                    click: function ($event) {
                      $event.stopPropagation()
                ...
                [
                  _c(
                    "text",
                    {
                      staticClass: _vm._$s(90, "sc", "dialog-title"),
                      attrs: { _i: 90 },
                    },
                    [
                      _vm._v(
                  ...
                  _c("text", {
                    staticClass: _vm._$s(91, "sc", "timer-form-label"),
                    attrs: { _i: 91 },
                  }),
                  _c("input", {
                    directives: [
                    ...
                    staticClass: _vm._$s(92, "sc", "dialog-input"),
                    attrs: { _i: 92 },
                    domProps: {
                      value: _vm._$s(92, "v-model", _vm.timerForm.name),
                    },
                    on: {
                      input: function ($event) {
                        if ($event.target.composing) {
                  ...
                  _c(
                    "view",
                    {
                      staticClass: _vm._$s(94, "sc", "timer-picker-row"),
                      attrs: { _i: 94 },
                    },
                    [
                      _c(
                        ...
                        [
                          _c(
                            "view",
                            {
                              staticClass: _vm._$s(96, "sc", "timer-picker"),
                              attrs: { _i: 96 },
                            },
                            [
                              _vm._v(
                  ...
                  _c("text", {
                    staticClass: _vm._$s(97, "sc", "timer-form-label"),
                    attrs: { _i: 97 },
                  }),
                  _c(
                    "view",
                    {
                      staticClass: _vm._$s(98, "sc", "timer-picker-row"),
                      attrs: { _i: 98 },
                    },
                    [
                      _c(
                        ...
                        {
                          attrs: {
                            range: _vm._$s(99, "a-range", _vm.taskTypeLabels),
                            _i: 99,
                          },
                          on: { change: _vm.onTaskTypeChange },
                        },
                        [
                          _c(
                            "view",
                            {
                              staticClass: _vm._$s(100, "sc", "timer-picker"),
                              attrs: { _i: 100 },
                            },
                            [
                              _vm._v(
                  ...
                  _c("text", {
                    staticClass: _vm._$s(101, "sc", "timer-form-label"),
                    attrs: { _i: 101 },
                  }),
                  _vm._$s(
                    102,
                    ...
                    ? _c(
                        "view",
                        {
                          staticClass: _vm._$s(102, "sc", "timer-picker-row"),
                          attrs: { _i: 102 },
                        },
                        [
                          _c(
                  ...
                  _c(
                    "view",
                    {
                      staticClass: _vm._$s(108, "sc", "dialog-buttons"),
                      attrs: { _i: 108 },
                    },
                    [
                      _c("button", {
        ...
        : _vm._e(),
      _vm._$s(111, "i", _vm.renameVisible)
        ? _c(
            "view",
            {
              staticClass: _vm._$s(111, "sc", "dialog-overlay"),
              attrs: { _i: 111 },
              on: { click: _vm.cancelRename },
            },
            [
              _c(
                "view",
                {
                  staticClass: _vm._$s(112, "sc", "dialog-box"),
                  attrs: { _i: 112 },
                  on: {
                    click: function ($event) {
                      $event.stopPropagation()
                ...
                [
                  _c("text", {
                    staticClass: _vm._$s(113, "sc", "dialog-title"),
                    attrs: { _i: 113 },
                  }),
                  _c("input", {
                    directives: [
                    ...
                    staticClass: _vm._$s(114, "sc", "dialog-input"),
                    attrs: { _i: 114 },
                    domProps: {
                      value: _vm._$s(114, "v-model", _vm.renameValue),
                    },
                    on: {
                      input: function ($event) {
                        if ($event.target.composing) {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _index_vue_vue_type_template_id_6a38acee_mpType_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=6a38acee&mpType=page */ 35);\n/* harmony import */ var _index_vue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.vue?vue&type=script&lang=js&mpType=page */ 37);\n/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _index_vue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_1__) if([\"default\"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _index_vue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_1__[key]; }) }(__WEBPACK_IMPORT_KEY__));\n/* harmony import */ var _HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../HBuilderX/plugins/uniapp-cli/node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/runtime/componentNormalizer.js */ 17);\n\nvar renderjs\n\n\n\n\n/* normalize component */\n\nvar component = Object(_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(\n  _index_vue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_1__[\"default\"],\n  _index_vue_vue_type_template_id_6a38acee_mpType_page__WEBPACK_IMPORTED_MODULE_0__[\"render\"],\n  _index_vue_vue_type_template_id_6a38acee_mpType_page__WEBPACK_IMPORTED_MODULE_0__[\"staticRenderFns\"],\n  false,\n  null,\n  null,\n  null,\n  false,\n  _index_vue_vue_type_template_id_6a38acee_mpType_page__WEBPACK_IMPORTED_MODULE_0__[\"components\"],\n  renderjs\n)\n\ncomponent.options.__file = \"pages/bind/index.vue\"\n/* harmony default export */ __webpack_exports__[\"default\"] = (component.exports);//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///34\n");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _HBuilderX_plugins_uniapp_cli_node_modules_babel_loader_lib_index_js_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_7_1_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_uni_app_loader_using_components_js_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../HBuilderX/plugins/uniapp-cli/node_modules/babel-loader/lib!../../../../../HBuilderX/plugins/uniapp-cli/node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--7-1!../../../../../HBuilderX/plugins/uniapp-cli/node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/using-components.js!../../../../../HBuilderX/plugins/uniapp-cli/node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./index.vue?vue&type=script&lang=js&mpType=page */ 38);\n/* harmony import */ var _HBuilderX_plugins_uniapp_cli_node_modules_babel_loader_lib_index_js_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_7_1_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_uni_app_loader_using_components_js_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_HBuilderX_plugins_uniapp_cli_node_modules_babel_loader_lib_index_js_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_7_1_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_uni_app_loader_using_components_js_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _HBuilderX_plugins_uniapp_cli_node_modules_babel_loader_lib_index_js_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_7_1_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_uni_app_loader_using_components_js_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_0__) if([\"default\"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _HBuilderX_plugins_uniapp_cli_node_modules_babel_loader_lib_index_js_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_7_1_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_uni_app_loader_using_components_js_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));\n /* harmony default export */ __webpack_exports__[\"default\"] = (_HBuilderX_plugins_uniapp_cli_node_modules_babel_loader_lib_index_js_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_preprocess_loader_index_js_ref_7_1_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_webpack_uni_app_loader_using_components_js_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_script_lang_js_mpType_page__WEBPACK_IMPORTED_MODULE_0___default.a); //# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///37\n");
